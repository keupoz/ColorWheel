(function (global, factory) {
  ...
  function ColorWheel (callback, size) {
  	...
  	registerEvent('touchstart', 'touchmove', 'touchend', 'touchcancel', function (e) { return [e.changedTouches[0].clientX, e.changedTouches[0].clientY]; });
  	registerEvent('mousedown', 'mousemove', 'mouseup', 'mouseleave', function (e) { return [e.clientX, e.clientY]; });
