...
export default function ColorWheel (callback, size = 256) {
	...
	function makePointRelative (point) {
		let rect = output.canvas.getBoundingClientRect();
	...
	registerEvent('touchstart', 'touchmove', 'touchend', 'touchcancel', e => [e.changedTouches[0].clientX, e.changedTouches[0].clientY]);
	registerEvent('mousedown', 'mousemove', 'mouseup', 'mouseleave', e => [e.clientX, e.clientY]);
